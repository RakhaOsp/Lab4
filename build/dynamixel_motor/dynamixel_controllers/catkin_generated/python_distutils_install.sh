...
echo_and_run cd "/home/rakhat123/lab4_fin/src/dynamixel_motor/dynamixel_controllers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/rakhat123/lab4_fin/src/dynamixel_motor/dynamixel_controllers/setup.py" \
     \
    build --build-base "/home/rakhat123/lab4_fin/build/dynamixel_motor/dynamixel_controllers" \
    install \
    --root="${DESTDIR-/}" \
